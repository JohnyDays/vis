 ...
 * @param {boolean | {duration: number, easingFunction: string, onDone: function}} [animation=false]
...
Range.prototype.setRange = function(start, end, animation, byUser) {
  ...
  if (animation) { // true or an Object
    ...
    var onDone = (typeof animation === 'object' && 'onDone' in animation) ? animation.onDone : null;
